...
import am.techshop.order.config.JwtAuthFilter;
...
class OrderControllerTest {
    ...
    private static OrderResponse sampleOrder(OrderStatus status) {
        return new OrderResponse(1L, USER_ID, List.of(), BigDecimal.valueOf(200), status,
                null, null, null, List.of(), PaymentMethod.IDRAM, "IDRAM-ref", PaymentStatus.PENDING, null, null, null);
    }

    @Test
    void checkout_ReturnsCreatedOrder() throws Exception {
        CheckoutRequest request = new CheckoutRequest(sampleAddress(), sampleAddress(), "Ring the bell", PaymentMethod.IDRAM);
    ...
    void checkout_WithoutAuthentication_ReturnsUnauthorized() throws Exception {
        CheckoutRequest request = new CheckoutRequest(sampleAddress(), sampleAddress(), null, PaymentMethod.IDRAM);
    ...
    void checkout_WithInvalidAddress_ReturnsBadRequest() throws Exception {
        ...
        CheckoutRequest request = new CheckoutRequest(blankAddress, blankAddress, null, PaymentMethod.IDRAM);
    ...
    void checkout_WithoutPaymentMethod_ReturnsBadRequest() throws Exception {
        CheckoutRequest request = new CheckoutRequest(sampleAddress(), sampleAddress(), null, null);
    ...
    void adminEndpoint_WhenCalledByAdmin_ReturnsPagedOrders() throws Exception {
        ...
        when(orderService.getAllOrders(null, 0, 20)).thenReturn(page);
    ...
    void getStatistics_WhenCalledByAdmin_ReturnsStatistics() throws Exception {
        ...
        when(orderService.getStatistics()).thenReturn(stats);
